...
drone_bot = UdpBot(start_lat=32.19965, start_lon=35.30593, start_alt=1000.0,
                    start_roll_d=0.0, start_pitch_d=0.0, start_yaw_d=0.0,
...
drone_bot.move_forward_backward(distance_m=200.0, duration_s=tff)

for i in range(3):

    drone_bot.move_forward_backward(distance_m=100, duration_s=tff)

    drone_bot.move_right_left(distance_m=50.0, duration_s=tff)
    drone_bot.move_up_down(distance_m=50.0, duration_s=tff)

    drone_bot.move_right_left(distance_m=-100.0, duration_s=(tff * 2))
    drone_bot.move_up_down(distance_m=-100.0, duration_s=(tff * 2))
